...
public class TestConfigs {
    ...
    public static final String ORIGIN_QUEROBIN = "https://querobin.com.br";
    public static final String ORIGIN_FLORIANO = "https://floriano.com.br";
}
